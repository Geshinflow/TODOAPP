...
const TodoList = ({ todos, handleDelete, setInputValue }) => {
    ...
    <section>
      ...
      <ul className="flex flex-col space-y-3">
        {todos.map((todo, todoindex) => (
          <li
            key={todoindex}
            className="bg-slate-700 p-5 flex justify-between "
          >
            {todo}
                ...
                <div>
                  ...
                  {isModalOpen && (
                    <div
                      id="popup-modal"
                      tabIndex="-1"
                      className="fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-gray-500 bg-opacity-50"
                    >
